        ...
        <Controller
          ...
          render={({ field }) => (
            <RadioGroupField
              ...
              error={
                errors.serviceType?.message ?? errors.serviceTypeOther?.message
              }
              otherPlaceholder={dict.fields.otherPlaceholder}
              onOtherChange={(v) =>
                setValue("serviceTypeOther", v, { shouldValidate: true })
              }
            />
          )}
        />
        ...
        <Controller
          ...
          render={({ field }) => (
            <RadioGroupField
              ...
              onChange={field.onChange}
              error={
                errors.projectType?.message ?? errors.projectTypeOther?.message
              }
              otherPlaceholder={dict.fields.otherPlaceholder}
              onOtherChange={(v) =>
                setValue("projectTypeOther", v, { shouldValidate: true })
              }
            />
          )}
        />
